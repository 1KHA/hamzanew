...
import GlobalStatisticsSection from "./components/GlobalStatisticsSection";
      ...
      <div className="">
        ...
        <section className="section-spacing-5xl custom-container">
          ...
          <div className="section-spacing-4xl">
            <CustomCarousel itemsPerSlide={3} gap={20}>
              {servicesCard}
            </CustomCarousel>
          </div>
        </section>
        ...
        <section className="section-spacing-5xl custom-container">
          <div className="">
            <div className="flex-between-center bg-white">
        ...
        <div className="bg-white">
          ...
          <section className="section-spacing-5xl custom-container">
            ...
            <div className="section-spacing-4xl">
              <CustomCarousel itemsPerSlide={partners.length-6} gap={20} showArrows={true} arrowRadius="20%" arrowBgColor="#F3F4F6">
                {partnersCards}
              </CustomCarousel>
            </div>
          </section>
