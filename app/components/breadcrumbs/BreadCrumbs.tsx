...
//     Array<BreadcrumbItem | { ellipsis: true; items: BreadcrumbItem[] }>
//   >([]);
...
//       return;
//     }
//     if (onBreadcrumbClick) onBreadcrumbClick(item, e);
//     // allow normal navigation if href present and not prevented by handler
//   }
...
//             if ((item as any).ellipsis) {
//               const ell = item as any;
//               return (
...
//                       {ell.items.map((it: BreadcrumbItem) => (
//                         <li
//                           key={it.label}
...
//                             }}
//                             className={
//                               it.disabled ? "disabled-link" : undefined
//                             }
...
//               >
//                 {!first && <span className="dga-breadcrumb-icon">{arrow}</span>}
//                 {b.path && !isLast ? (
//                   <a
...
//                   >
//                     <span className="link__label">{b.label}</span>
//                   </a>
//                 ) : (
//                   <span
