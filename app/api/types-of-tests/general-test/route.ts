...
export async function GET() {
  try {
    ...
    console.log("Hamza General Test API - Language:", locale);
    ...
    console.log("Hamza General Test - Header:", headerContent?.title);
    console.log("Hamza General Test - Test Sections:", testSectionsContent?.title);
    console.log("Hamza General Test - Ready:", areYoureadyContentData?.title);
    ...
    console.error("Error fetching hamza general test content:", error);
    return NextResponse.json(
      {
        header: {
