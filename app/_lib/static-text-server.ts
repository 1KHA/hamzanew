...
export const STATIC_TEXT: Record<string, Record<string, { ar: string; en: string }>> = {
  ...
  eParticipation: {
    ...
    fileTypesText: {
      ar: "الحد الأقصى لحجم الملف المسموح به هو 5 ميجابايت، وصيغ الملفات المدعومة تشمل jpg, png, pdf.",
      en: "Maximum file size allowed is 5 MB, supported formats include jpg, png, and pdf.",
    },
  ...
  testTakers: {
    ...
    testCentersMetaTitle: { ar: "مراكز اختبار همزة", en: "Hamza Test Centers" },
    testCentersTitle: { ar: "مراكز الاختبار", en: "Test Centers" },
    testCentersLocalCenter: { ar: "مركز محلي", en: "Local Center" },
    testCentersOnline: { ar: "عن بُعد", en: "Online" },
    testCentersSpecialNeeds: { ar: "احتياجات خاصة", en: "Special Needs" },
    testCentersTestTypePlaceholder: { ar: "نوع الاختبار", en: "Test Type" },
    testCentersCountryPlaceholder: { ar: "الدولة", en: "Country" },
    testCentersNoCenters: { ar: "لا توجد مراكز اختبار متاحة", en: "No test centers available" },
    testCentersNoTest: { ar: "لا يوجد اختبار متاح", en: "No test available" },
    testCentersRegistrationStatus: { ar: "حالة التسجيل", en: "Registration Status" },
    testCentersAvailable: { ar: "متاح", en: "Available" },
    testCentersUnavailable: { ar: "غير متاح", en: "Unavailable" },
    testCentersSpecialNeedsButton: { ar: "طلب تسجيل", en: "Request Registration" },
  },
  signIn: {
  ...
  forgotPassword: {
    headingEmail: { ar: "نسيت كلمة المرور الخاصة بي", en: "Forgot my password" },
    headingValidating: { ar: "التحقق من الرابط", en: "Verifying link" },
    headingReset: { ar: "إعادة تعيين كلمة المرور", en: "Reset password" },
    subtitleEmail: { ar: "أدخل بريدك الإلكتروني وسنرسل إليك رابط إعادة تعيين كلمة المرور", en: "Enter your email and we will send you a password reset link" },
    subtitleValidating: { ar: "يرجى الانتظار، جارٍ التحقق من صلاحية الرابط…", en: "Please wait while we verify the link…" },
    subtitleReset: { ar: "أدخل كلمة المرور الجديدة وتأكيدها لإتمام عملية الاسترداد", en: "Enter and confirm your new password to complete the recovery" },
    formAriaEmail: { ar: "نموذج استعادة كلمة المرور", en: "Password recovery form" },
    formAriaReset: { ar: "نموذج إعادة تعيين كلمة المرور", en: "Password reset form" },
    emailLabel: { ar: "البريد الإلكتروني", en: "Email" },
    emailPlaceholder: { ar: "أدخل بريدك الإلكتروني", en: "Enter your email" },
    emailHelp: { ar: "أدخل البريد الإلكتروني المرتبط بحسابك", en: "Enter the email associated with your account" },
    emailRequired: { ar: "البريد الإلكتروني مطلوب", en: "Email is required" },
    emailInvalid: { ar: "البريد الإلكتروني غير صحيح", en: "Invalid email address" },
    sendLinkBtn: { ar: "إرسال رابط إعادة التعيين", en: "Send reset link" },
    sending: { ar: "جاري الإرسال...", en: "Sending..." },
    sendFailed: { ar: "تعذّر إرسال رابط إعادة التعيين", en: "Could not send the reset link" },
    sentHeading: { ar: "تحقق من بريدك الإلكتروني", en: "Check your email" },
    sentBody1: { ar: "أرسلنا رابط إعادة تعيين كلمة المرور إلى", en: "We sent a password reset link to" },
    sentBody2: { ar: ". افتح الرابط من بريدك لمتابعة العملية.", en: ". Open the link from your inbox to continue." },
    noLinkReceived: { ar: "لم يصلك الرابط؟", en: "Didn't receive the link?" },
    resendAfter: { ar: "إعادة الإرسال بعد {countdown} ث", en: "Resend after {countdown}s" },
    resendBtn: { ar: "إعادة إرسال الرابط", en: "Resend link" },
    resendFailed: { ar: "تعذّر إعادة إرسال الرابط", en: "Could not resend the link" },
    validatingBody: { ar: "جارٍ التحقق من الرابط…", en: "Verifying the link…" },
    newPasswordLabel: { ar: "كلمة المرور الجديدة", en: "New password" },
    newPasswordPlaceholder: { ar: "أدخل كلمة المرور الجديدة", en: "Enter the new password" },
    confirmPasswordLabel: { ar: "تأكيد كلمة المرور", en: "Confirm password" },
    confirmPasswordPlaceholder: { ar: "أعد إدخال كلمة المرور الجديدة", en: "Re-enter the new password" },
    confirmPasswordRequired: { ar: "تأكيد كلمة المرور مطلوب", en: "Password confirmation is required" },
    ...
    rulesAria: { ar: "متطلبات كلمة المرور", en: "Password requirements" },
    rulesIntro: { ar: "يجب أن تحتوي كلمة المرور على رمز خاص (@$!#%*?&)، أرقام، حروف صغيرة، وحرف كبير واحد على الأقل، وأن لا تقل عن 8 خانات", en: "Password must contain a special character (@$!#%*?&), numbers, lowercase letters, at least one uppercase letter, and be at least 8 characters long" },
    ruleLength: { ar: "الحد الأدنى 8 أحرف", en: "At least 8 characters" },
    ruleUpper: { ar: "حرف كبير واحد على الأقل", en: "At least one uppercase letter" },
    ruleLower: { ar: "حرف صغير واحد على الأقل", en: "At least one lowercase letter" },
    ruleDigit: { ar: "رقم واحد على الأقل", en: "At least one number" },
    ruleSpecial: { ar: "رمز خاص واحد على الأقل (@$!#%*?&)", en: "At least one special character (@$!#%*?&)" },
    ruleSpaces: { ar: "لا يحتوي على مسافات", en: "No spaces" },
    ruleMet: { ar: "مستوفى", en: "met" },
    ruleUnmet: { ar: "غير مستوفى", en: "not met" },
    savingBtn: { ar: "جاري الحفظ...", en: "Saving..." },
    resetBtn: { ar: "إعادة تعيين كلمة المرور", en: "Reset password" },
    resetFailed: { ar: "تعذّر إعادة تعيين كلمة المرور", en: "Could not reset the password" },
    invalidHeading: { ar: "رابط غير صالح", en: "Invalid link" },
    invalidLead: { ar: "الرابط غير صالح أو منتهي الصلاحية", en: "The link is invalid or has expired" },
    invalidHelper: { ar: "يرجى طلب رابط جديد لإعادة تعيين كلمة المرور", en: "Please request a new password reset link" },
    requestNewLink: { ar: "طلب رابط جديد", en: "Request a new link" },
    doneHeading: { ar: "تم بنجاح", en: "Success" },
    doneLead: { ar: "تم إعادة تعيين كلمة المرور بنجاح", en: "Your password has been reset successfully" },
    doneHelper: { ar: "يمكنك الآن تسجيل الدخول باستخدام كلمة مرورك الجديدة", en: "You can now sign in with your new password" },
    goToSignIn: { ar: "الذهاب إلى تسجيل الدخول", en: "Go to sign in" },
    rememberedPassword: { ar: "تذكرت كلمة المرور؟", en: "Remembered your password?" },
    signInLink: { ar: "تسجيل الدخول", en: "Sign in" },
  },
  discoverTests: {
  ...
  signUp: {
    ...
    identityNumberPassportFormat: { ar: "رقم جواز السفر يجب أن يتكون من 6 إلى 12 حرفاً أو رقماً إنجليزياً", en: "Passport number must be 6–12 English letters or digits" },
    identityNumberNationalIdFormat: { ar: "رقم الهوية يجب أن يتكون من 10 أرقام", en: "ID number must be 10 digits" },
    identityNumberFormat: { ar: "رقم الإثبات يجب أن يحتوي على حروف أو أرقام إنجليزية فقط", en: "ID number must contain English letters or digits only" },
    ...
    /* ── UI chrome (page, steps, buttons) ── */
    pageTitle: { ar: "إنشاء حساب جديد", en: "Create a new account" },
    pageSubtitle1: { ar: "أنشئ حسابك في منصة اختبارات همزة بسهولة عبر إدخال بياناتك الأساسية.", en: "Create your Hamza Tests platform account easily by entering your basic information." },
    pageSubtitle2: { ar: "بمجرد التسجيل يمكنك الوصول للاختبارات، متابعة النتائج، وإدارة ملفك الشخصي.", en: "Once registered, you can access tests, track results, and manage your profile." },
    requiredNote: { ar: "المعلومات المطلوبة", en: "Required information" },
    step1Title: { ar: "معلومات الحساب", en: "Account Information" },
    step2Title: { ar: "المعلومات الشخصية", en: "Personal Information" },
    step3Title: { ar: "المؤهلات الدراسية", en: "Educational Qualifications" },
    step4Title: { ar: "الموقع", en: "Location" },
    stepDescription: { ar: "وصف الخطوة", en: "Step description" },
    stepsAria: { ar: "خطوات إنشاء الحساب", en: "Account creation steps" },
    ...
    submitErrorFallback: { ar: "حدث خطأ أثناء إنشاء الحساب. يرجى المحاولة مرة أخرى.", en: "An error occurred while creating the account. Please try again." },
    successLead: { ar: "تحقق من بريدك الشبكي", en: "Check your email" },
    successHelper: { ar: "لقد أرسلنا رسالة إلى عنوان بريدك الشبكي تتضمن الخطوات التالية لإكمال التسجيل. يرجى مراجعة بريدك الوارد (وربما مجلد الرسائل غير المرغوب فيها).", en: "We've sent a message to your email address with the next steps to complete your registration. Please check your inbox (and possibly your spam folder)." },
    goToSignIn: { ar: "الذهاب إلى تسجيل الدخول", en: "Go to sign in" },

    /* ── Step 1: account info fields ── */
    emailLabel: { ar: "البريد الشبكي", en: "Email" },
    emailHelp: { ar: "أدخل عنوان بريدك الشبكي المستخدم لتسجيل الدخول", en: "Enter the email address you will use to sign in" },
    phoneLabel: { ar: "رقم الجوال", en: "Mobile number" },
    countryCodeAria: { ar: "رمز الدولة", en: "Country code" },
    passwordLabel: { ar: "كلمة السر", en: "Password" },
    confirmPasswordLabel: { ar: "تأكيد كلمة السر", en: "Confirm password" },

    /* ── Step 2: personal info fields ── */
    firstNameAr: { ar: "الاسم الاول", en: "First name" },
    firstNameEn: { ar: "الاسم الاول (باللغة الإنجليزية)", en: "First name (in English)" },
    secondNameAr: { ar: "الاسم الثاني", en: "Second name" },
    secondNameEn: { ar: "الاسم الثاني (باللغة الإنجليزية)", en: "Second name (in English)" },
    lastNameAr: { ar: "الاسم الأخير", en: "Last name" },
    lastNameEn: { ar: "الاسم الأخير (باللغة الإنجليزية)", en: "Last name (in English)" },
    birthDateLabel: { ar: "تاريخ الميلاد", en: "Date of birth" },
    nationalityLabel: { ar: "الجنسية", en: "Nationality" },
    nationalityPlaceholder: { ar: "اختر الجنسية", en: "Select nationality" },
    motherTongueLabel: { ar: "اللغة الأم", en: "Mother tongue" },
    motherTonguePlaceholder: { ar: "اختر اللغة الأم", en: "Select mother tongue" },
    identityLabel: { ar: "الاثبات", en: "ID type" },
    identityPlaceholder: { ar: "اختر نوع الاثبات", en: "Select ID type" },
    identityNumberLabel: { ar: "ادخل رقم الاثبات", en: "Enter ID number" },
    identityFileLabel: { ar: "ارفق نسخة من الاثبات", en: "Attach a copy of your ID" },
    identityFileTypes: { ar: "الحد الأقصى لحجم الملف المسموح به هو 5 ميجابايت، وصيغ الملفات المدعومة تشمل jpg, png, pdf.", en: "Maximum allowed file size is 5 MB; supported formats include jpg, png, pdf." },
    browseFiles: { ar: "تصفح الملفات", en: "Browse files" },
    ...
    timezoneLabel: { ar: "المنطقة الزمنية", en: "Time zone" },
    timezonePlaceholder: { ar: "اختر المنطقة الزمنية", en: "Select time zone" },
    countryLabel: { ar: "الدولة", en: "Country" },
    countryPlaceholder: { ar: "اختر الدولة", en: "Select country" },
    stateLabel: { ar: "الولاية/المقاطعة/الإقليم", en: "State/Province/Region" },
    statePlaceholder: { ar: "أدخل الولاية", en: "Enter state" },
    cityLabel: { ar: "المدينة", en: "City" },
    cityPlaceholder: { ar: "أدخل المدينة", en: "Enter city" },
    streetLabel: { ar: "الشارع", en: "Street" },
    streetPlaceholder: { ar: "اسم الشارع", en: "Street name" },
    zipLabel: { ar: "الرمز البريدي", en: "Postal code" },
  },
  meranCourse: {
    /* ── Metadata & hero ────────────────────────────────────────────────────── */
  ...
  profile: {
    ...
    fileUploadTypesText: { ar: "الحد الأقصى لحجم الملف المسموح به هو 5 ميجابايت، وصيغ الملفات المدعومة تشمل PDF, PNG, JPG, JPEG.", en: "Maximum file size allowed is 5 MB, supported formats include PDF, PNG, JPG, JPEG." },
